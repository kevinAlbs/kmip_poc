...
export PKG_CONFIG_PATH=~/code/c-bootstrap/install/libmongocrypt-1.7.1/lib/pkgconfig
export DYLD_LIBRARY_PATH=~/code/c-bootstrap/install/libmongocrypt-1.7.1/lib/
